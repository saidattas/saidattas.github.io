...
$(function () {
	...
	((Revealator = $.extend(
		...
		0 === a.scrollTop()
			? o.hasClass('at-top') ||
				o.addClass('at-top').removeClass('at-bottom').removeClass('near-top').removeClass('near-bottom')
			: a.scrollTop() + a.height() === e.height()
				? o.hasClass('at-bottom') ||
					o.addClass('at-bottom').removeClass('at-top').removeClass('near-top').removeClass('near-bottom')
				: a.scrollTop() <= r
					? o.hasClass('near-top') ||
						o.addClass('near-top').removeClass('near-bottom').removeClass('at-top').removeClass('at-bottom')
					: a.scrollTop() + a.height() >= s
						? o.hasClass('near-bottom') ||
							o.addClass('near-bottom').removeClass('near-top').removeClass('at-top').removeClass('at-bottom')
						: (o.hasClass('at-top') ||
								o.hasClass('at-bottom') ||
								o.hasClass('near-top') ||
								o.hasClass('near-bottom')) &&
							o.removeClass('at-top').removeClass('at-bottom').removeClass('near-top').removeClass('near-bottom'),
					...
					e.top > l && e.bottom > l
						...
						: e.top < l && e.bottom > l
							...
							: e.top < t && e.bottom > t
								...
								: e.top < t && e.bottom < t ? 'revealator-above' : 'revealator-within'),
					...
					a.hasClass(o) ||
						...
						(a.hasClass('revealator-once')
							? (a.hasClass('revealator-within') ||
									...
									a.addClass(o)),
								(a.hasClass('revealator-partially-above') || a.hasClass('revealator-above')) &&
									a.addClass('revealator-within'))
							: (a.removeClass(
									'revealator-below revealator-partially-below revealator-within revealator-partially-above revealator-above'
								),
